		...
		<>
			...
			{redirect_status == "succeeded" ? (
				...
				<div className="flex flex-col gap-3 items-center mt-14">
					<img src={"https://i.goopics.net/22c5x7.png"} width={80} height={80} className="w-36 opacity-90" />
					<span className="text-sm text-gray-600 ">Paiement effectué avec succès !</span>
				</div>
