    ...
    return (
        <div className="drawer drawer-end fixed z-50">
            ...
            <div className="drawer-side">
                ...
                {
                    !personalChat.state ? <ListItemChat handleChange={() => handleChange()} /> : <Conversation close={() => setDraw(false)} messages={allMessages} isLoading={isLoading} isError={isError} user={session.user.data.names} />
                }
...
function Conversation({ close, messages, isLoading, isError, user }) {
    ...
    return (
        <div className="flex flex-col bg-gray-100 flex-auto md:w-96 w-full h-full relative">
            ...
            <div
                className="flex flex-col flex-auto flex-shrink-0 bg-gray-100 min-h-full pt-20 relative"
            >

                {
                    isLoading ? (<div className="flex h-full justify-center items-center text-gray-400">
                        Loading...
                    </div>) : (
                ...
                >
                    ...
                    <div className="ml-4">
                        <button
                            className="flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 rounded-xl text-white px-4 py-3 h-fit flex-shrink-0"
                        >
                            <span className="ml-2">
                                <svg
