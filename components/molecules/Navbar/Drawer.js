...
export default function Drawer() {
    const [personalChat, setPersonalChat] = useState({state: false});
    ...
    return (
        <div className="drawer drawer-end fixed z-50">
            ...
            <div className="drawer-side">
                ...
                {
                    !personalChat.state ? <ListItemChat handleChange={() => handleChange()}/> : <Conversation />
                }
...
function Conversation() {
    return (
        <div class="flex flex-col flex-auto md:w-72 w-full h-full p-6">
        <div
