    ...
    return (
        <div className="drawer drawer-end fixed z-50">
            ...
            <div className="drawer-side">
                ...
                {
                    !personalChat.state ? <ListItemChat handleChange={() => handleChange()} /> : <Conversation close={() => setDraw(false)} messages={allMessages} isLoading={isLoading} isError={isError} user={session.user.data.names} senderId={session.user.data.userId} token={session.user.data.access_token} />
                }
