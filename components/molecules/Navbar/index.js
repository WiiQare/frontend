...
const Menu = () => {
    return (
        <div className='flex gap-12 mx-auto items-center justify-between fixed py-4 px-14 shadow-sm w-full'>
            <div className='flex gap-16 items-center'>
                <div className='flex gap-2 items-center'>
                    <Link href={"/"} legacyBehavior>
                        <Image
                            src={logo}
                            className="h-14 w-min object-left object-contain"
                        />
                    </Link>
                    <Link href={"/"} legacyBehavior>
                        <Image
                            src={logoDark}
                            className="h-9 object-left object-contain w-min"
                        />
                    </Link>
