        ...
        <div className="flex flex-col py-8 px-5 md:w-72 w-full bg-white flex-shrink-0">
            ...
            <div className="flex flex-col mt-8">
                ...
                <div className="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
                    <ItemMessage name={"Bienvenu Z."} message={2} onClick={() => handleChange(1)} />
                    <ItemMessage name={"Brice A."} message={0} onClick={() => handleChange(2)} />
                    <ItemMessage name={"Fred Muyco"} message={0} onClick={() => handleChange(3)} />
                    <ItemMessage name={"Aleks M"} message={1} onClick={() => handleChange(4)} />
                    <ItemMessage name={"John Doe"} message={1} onClick={() => handleChange(5)} />
                </div>
                ...
                <div className="flex flex-col space-y-1 mt-4 -mx-2">
                    <ItemMessage name={"Jane Doe"} message={7} onClick={() => handleChange(6)} />
                </div>
            </div>
        </div>
    );
...
function ItemMessage({name, message, onClick}) {
    return (
        <button className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2" onClick={() => onClick(2)}>
