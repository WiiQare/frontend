  ...
  return (
    <div className="flex flex-col bg-gray-100 flex-auto md:w-96 w-full h-full relative">
      ...
      <div className="flex flex-col flex-auto flex-shrink-0 bg-gray-100 min-h-full pt-20 relative">
        ...
        <div className="flex flex-row items-center h-16 bg-white w-full px-4 absolute md:bottom-20 bottom-40">
          <div>
          ...
          <div className="ml-4">
            <button className="flex items-center justify-center bg-indigo-500 hover:bg-indigo-600 rounded-xl text-white px-4 py-3 h-fit flex-shrink-0">
              <span className="ml-2">
                <svg
