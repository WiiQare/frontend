      ...
      <Form className="flex justify-center md:w-2/4 w-full  py-4 items-end">
        <div className="space-y-1 md:w-3/4">
          <div className="flex items-end gap-4">
            ...
            <button
              type="submit"
              className="bg-primary flex gap-3 items-center w-fit font-medium text-white py-3 md:px-5 px-2 text-sm md:text-md hover:bg-blue-500 duration-200 transition-all hover:shadow rounded-lg"
            >
              Checkout
            </button>
          </div>
