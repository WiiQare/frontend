						...
						<div className="flex flex-col items-start space-y-1 relative">
							...
							{requestComplete && (
								<div className="absolute right-4 top-1/2">
									<div className="animate-spin inline-block w-4 h-4 border-[1px] border-current border-t-transparent text-blue-400 rounded-full" role="status" aria-label="loading">
