            ...
            <div className="flex flex-col gap-4">
              ...
              <span className="w-full bg-gray-100 text-gray-500 h-fit p-2 rounded-lg flex gap-2 items-start text-sm">
                ...
                <span className="leading-6 font-light">
                  ...
                  veritatis aliquam, sunt odio, voluptate aspernatur molestias
                  illum a, ratione totam sint amet nisi exercitationem culpa
                  dolorem quo enim harum esse!
                </span>
              </span>
            </div>
          </div>
            ...
            <div className="w-full px-8 absolute top-6 flex flex-col gap-5">
              <div className="flex justify-between">
                <div className="space-y-1">
                  <p className="font-extralight">Peter NDENGO M.</p>
