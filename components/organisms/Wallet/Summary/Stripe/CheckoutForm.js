    ...
    return (
        <form id="payment-form" onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="w-full flex flex-row-reverse">
				...
				<button disabled={isLoading || !stripe || !elements} type="submit" className="mb-8 w-full rounded-md bg-orange effect-up px-6 py-4 font-medium text-white">{!isLoading ? "Procéder au paiement"  : "Chargement..."}</button>
