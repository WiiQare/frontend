...
const StripePayment = () => {
    ...
    if (!saving.plan)
        return (
            <>Aucun Plan n'a été selectionner</>
        )
                        ...
                        <div className="px-4 pt-8">
                            ...
                            <div className="items-center sm:flex w-full">
                                <div className="py-5 w-full">
                                    <h3 className="text-xl font-semibold tracking-tight text-gray-900 ">
                                        <a href="#">
                                            Épargne - <span className="text-orange font-bold">{saving.title}</span>
                                        </a>
                                    </h3>
                            ...
                            <div className="mt-6 border-t border-b py-2 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="font-normal text-sm text-gray-600">
                                        {saving.plan.type == "DAY" ? "Journalier" : saving.plan.type == "WEEK" ? "Hebdomadaire" : saving.plan.type == "MONTH" ? "Mensuel" : "---"}
                                    </p>
                                </div>
